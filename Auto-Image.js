(async () => {
  const CONFIG = {
    ...
    CAPTCHA_API_KEY: 'YOUR_2CAPTCHA_API_KEY_HERE', // Obtenha em 2captcha.com
    SITE_KEY: 'THE_SITEKEY_FROM_WPLACE_LIVE' // Inspecione a página wplace.live e encontre data-sitekey no elemento Turnstile
  };
